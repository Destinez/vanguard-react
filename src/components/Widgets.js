...
import { Col, Row, Card, Image, Button, ListGroup, ProgressBar, Badge } from '@themesberg/react-bootstrap';
...
export const ProfileCardWidget = (props) => {
  const { name, email, country } = props
  return (
    <Card border="light" className="text-center p-0 mb-4">
      ...
      <Card.Body className="pb-5">
        ...
        <Card.Subtitle className="font-weight-bolder text-info">{email}</Card.Subtitle>
        <Card.Text className="text-gray mb-4">{country}</Card.Text>
...
export const Plans = (props) => {
  const { title, roi, duration, description, plan_id, planID, setPlanID } = props;
        ...
        <Row className="d-block d-xl-flex align-items-center ">
          ...
          <Col md={12} className="mb-2">
            <Row className="bg-light align-items-center m-auto">
              <Col md={6}>
                <h5 className="my-1 text-danger">{roi}</h5>
              </Col>
              <Col md={6}>
                <Badge bg="warning" text="dark" className="badge-lg">{duration}</Badge>
              </Col>
            </Row>
          </Col>
          ...
          <div className="mt-2 mb-0">
            <Button variant="secondary" onClick={setPlanID(55)} className="w-100" type="submit">Trade Now {planID}</Button>
          </div>
